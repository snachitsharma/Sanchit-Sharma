...
// Animated Background Component - Vibrant & Visible
...
export function App() {
  ...
  return (
    <div className="min-h-screen bg-transparent text-white relative">
      ...
      <section className="min-h-screen flex items-center justify-center pt-16 px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => scrollToSection('book-call')}
              className="neon-button neon-button-orange text-white px-6 py-3 rounded-lg font-medium text-base transition-all flex items-center justify-center gap-2"
            >
      ...
      {/* Book a Call Section */}
      <section id="book-call" className="py-20 px-6">
        <div className="max-w-4xl mx-auto">
            ...
            {formSubmitted ? (
              ...
              <form onSubmit={handleSubmit} className="max-w-xl mx-auto relative z-10">
                ...
                <button
                  ...
                  className="neon-button neon-button-orange w-full disabled:opacity-50 disabled:cursor-not-allowed text-white py-4 rounded-lg font-medium transition-colors flex items-center justify-center gap-2"
                >
                  {isSubmitting ? (
                    <>
